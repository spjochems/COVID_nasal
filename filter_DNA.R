...
setwd('C:/Users/spjochems/Dropbox/LUMC/Results/CyTOF/BEAT-COVID/Day4/1.Cytofclean/')
...
for(j in 1:length(files)){
  ...
  setwd("C:/Users/spjochems/Dropbox/LUMC/Results/CyTOF/BEAT-COVID/Day4/2.Filter_DNA")
  dir.create('Pics')
